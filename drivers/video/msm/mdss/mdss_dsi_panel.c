							...
							u32 bl_level)
{
	...
	case BL_DCS_CMD:
#ifdef CONFIG_HUAWEI_LCD
		/* make sure the first pwm signal longer than 2us when panel
		   wake up from sleep*/
...
/* add dynamic log */
	...
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->dsi_panel_cabc_ui_cmds,
		"qcom,panel-cabc-ui-cmds",
		"qcom,cabc-ui-cmds-dsi-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->dsi_panel_cabc_video_cmds,
		"qcom,panel-cabc-video-cmds",
		"qcom,cabc-video-cmds-dsi-state");
#endif
#ifdef CONFIG_FB_DISPLAY_INVERSION
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->dsi_panel_inverse_on_cmds,
		"qcom,panel-inverse-on-cmds",
		"qcom,inverse-on-cmds-dsi-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->dsi_panel_inverse_off_cmds,
		"qcom,panel-inverse-off-cmds",
		"qcom,inverse-on-cmds-dsi-state");
#endif
#ifdef CONFIG_HUAWEI_LCD
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->temporary_pwm_cmds,
		"qcom,panel-SetTemporary-pwm-cmds",
		"qcom,temporary-pwm-command-dsi-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->normal_pwm_cmds,
		"qcom,panel-SetNormal-pwm-cmds",
		"qcom,normal-pwm-command-dsi-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->dot_inversion_cmds,
		"qcom,panel-dot-inversion-mode-cmds",
		"qcom,dot-inversion-cmds-dsi-state");
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->column_inversion_cmds,
		"qcom,panel-column-inversion-mode-cmds",
		"qcom,column-inversion-cmds-dsi-state");
